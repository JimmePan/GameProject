...
public:
	...
	bool getMoveFlag() const { return _moveFlag; };
	void setMoveFlag(bool moveFlag) { _moveFlag = moveFlag; }
	int getCount() const { return _counter; }
	bool getBoss() const { return _boss; };
	int getBossCount()const { return _bossCount; }
